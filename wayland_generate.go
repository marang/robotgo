...
//go:generate curl -L https://raw.githubusercontent.com/wayland-mirror/wayland-protocols/main/unstable/xdg-output/xdg-output-unstable-v1.xml -o xdg-output-unstable-v1.xml
//go:generate sh -c "wayland-scanner client-header xdg-output-unstable-v1.xml xdg-output-unstable-v1-client-protocol.h && wayland-scanner private-code xdg-output-unstable-v1.xml xdg-output-unstable-v1-client-protocol.c && sed -i '1i//go:build linux && wayland\\n// +build linux,wayland' xdg-output-unstable-v1-client-protocol.c && rm xdg-output-unstable-v1.xml"
