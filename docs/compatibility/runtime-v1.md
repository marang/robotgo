...
| GNOME/Wayland | CGO and Pure Go portal paths | supported for single-output portal input/capture; multi-output evidence pending | Retained exact-commit [`RemoteDesktop`](https://github.com/marang/robotgo/actions/runs/30199452053) and [`ScreenCast`](https://github.com/marang/robotgo/actions/runs/30199195890) nested-GNOME evidence; compositor-wide window control and multi-output portal/geometry coverage remain capability/evidence gaps |
| KDE Plasma/Wayland | CGO and Pure Go portal paths | supported for single-output portal input/capture; multi-output evidence pending | Retained exact-commit [`RemoteDesktop`](https://github.com/marang/robotgo/actions/runs/30204553569) and [`ScreenCast`](https://github.com/marang/robotgo/actions/runs/30214614314) nested-KDE evidence; compositor-wide window control, multi-output portal/geometry coverage, and exact-release promotion remain gaps |
