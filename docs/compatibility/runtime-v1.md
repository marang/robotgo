...
| Linux/Wayland/wlroots | Native CGO, `wayland` | supported for advertised protocols | Weston integration plus hermetic tests and retained [`Sway E2E` run 29857289675](https://github.com/marang/robotgo/actions/runs/29857289675) for native input/capture/window/output and portal availability; a distinct hosted multi-output Sway evidence cell is in progress and compositor-specific protocols remain capability-gated |
